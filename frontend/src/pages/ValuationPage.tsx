        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 text-center shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">1. Ingresa los datos</h3>
            ...
            <div className="bg-white rounded-2xl p-8 text-center shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">2. Calculamos el valor</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-8 text-center shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">3. Recibe tu valuación</h3>
              <p className="text-gray-600">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-xl">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Basada en datos reales</h3>
            ...
            <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-xl">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Resultado instantáneo</h3>
                <p className="text-gray-600 text-sm">
            ...
            <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-xl">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">100% gratuita</h3>
                <p className="text-gray-600 text-sm">
            ...
            <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-xl">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Todas las marcas</h3>
                <p className="text-gray-600 text-sm">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {!isAuthenticated && (
              <Link
                to="/register"
                className="border border-gray-600 hover:bg-gray-800 text-white px-8 py-4 rounded-xl font-semibold text-lg inline-flex items-center gap-2 transition-colors"
              >
                Crear cuenta gratis
              </Link>
            )}
